 ...
 * @since 1.0
 */
public class OhosFileDocument extends FileDocument {
    ...
    private OhosProject ohosProject;

    public OhosFileDocument(final File file) {
        super(file);
    }
    ...
    public OhosProject getOhosProject() {
        return this.ohosProject;
    }

    public void setOhosProject(final OhosProject ohosProject) {
        this.ohosProject = ohosProject;
        this.getMetaData().set(new MetaData.Datum("ProjectName", ohosProject.getName()));
    }
    ...
    public void copyData(final OhosFileDocument fileDocument) {
