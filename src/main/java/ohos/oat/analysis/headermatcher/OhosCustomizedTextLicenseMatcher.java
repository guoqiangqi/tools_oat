...
public class OhosCustomizedTextLicenseMatcher extends OhosFullTextLicenseMatcher {
    public OhosCustomizedTextLicenseMatcher(final String licenseName, final String licenseText) {
