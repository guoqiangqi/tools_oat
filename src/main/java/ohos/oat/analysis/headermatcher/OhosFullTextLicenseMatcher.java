 ...
 * @since 1.0
 */
public class OhosFullTextLicenseMatcher extends BaseLicense implements IOhosHeaderMatcher {
    ...
    public OhosFullTextLicenseMatcher(final String licenseFamilyName, final String licenseName, final String notes,
    ...
    public OhosFullTextLicenseMatcher(final MetaData.Datum licenseFamilyCategory,
        final MetaData.Datum licenseFamilyName, final String notes, final String licenseText) {
