 ...
 * @since 1.0
 */
public class OhosSpdxTextLicenseMatcher extends OhosFullTextLicenseMatcher {
    private final List<String> urls = new ArrayList<>();

    public OhosSpdxTextLicenseMatcher(final String licenseName, final String licenseText, final List<String> urls) {
