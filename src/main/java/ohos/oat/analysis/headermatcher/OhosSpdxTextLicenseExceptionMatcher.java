 ...
 * @since 1.0
 */
public class OhosSpdxTextLicenseExceptionMatcher extends OhosFullTextLicenseMatcher {
    private final List<String> urls = new ArrayList<>();

    public OhosSpdxTextLicenseExceptionMatcher(final String licenseName, final String licenseText,
