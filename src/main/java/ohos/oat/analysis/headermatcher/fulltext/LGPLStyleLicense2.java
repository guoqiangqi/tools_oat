 ...
 * @since 1.0
 */
public class LGPLStyleLicense2 extends OhosDefaultFullTextLicenseMatcher {
    private static final String LICENSE_LINE_1 = "GNU Library General Public License";

    public LGPLStyleLicense2() {
        super(new MetaData.Datum(RAT_URL_LICENSE_FAMILY_CATEGORY, "LGPLStyleLicense"),
            new MetaData.Datum(RAT_URL_LICENSE_FAMILY_NAME, "LGPLStyleLicense"), "", LGPLStyleLicense2.LICENSE_LINE_1);
    }
