 ...
 * @since 1.0
 */
public class GPL3License extends OhosDefaultFullTextLicenseMatcher {
    ...
    public GPL3License() {
        super(new MetaData.Datum(RAT_URL_LICENSE_FAMILY_CATEGORY, "GPL-3.0+"),
            new MetaData.Datum(RAT_URL_LICENSE_FAMILY_NAME, "GPL-3.0+"), "", LICENSE_LINE_1);
    }
