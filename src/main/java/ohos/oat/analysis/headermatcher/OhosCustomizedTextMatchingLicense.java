...
public class OhosCustomizedTextMatchingLicense extends FullTextMatchingLicense {
    public OhosCustomizedTextMatchingLicense(final String licenseName, final String licenseText) {
