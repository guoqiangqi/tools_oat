 ...
 * @since 1.0
 */
public class OhosDefaultSimplePatternLicenseMatcher extends OhosSimplePatternLicenseMatcher {

    protected OhosDefaultSimplePatternLicenseMatcher(final MetaData.Datum pLicenseFamilyCategory,
        ...
        super(pLicenseFamilyCategory, pLicenseFamilyName, pNotes,
            OhosLicenseTextUtil.cleanAndLowerCaseArray(pPatterns));
    }
