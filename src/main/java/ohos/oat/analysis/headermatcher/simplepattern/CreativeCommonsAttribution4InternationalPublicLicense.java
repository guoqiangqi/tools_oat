 ...
 * @since 1.0
 */
public class CreativeCommonsAttribution4InternationalPublicLicense extends OatDefaultSimplePatternLicenseMatcher {
    public CreativeCommonsAttribution4InternationalPublicLicense() {
        super(new MetaData.Datum(RAT_URL_LICENSE_FAMILY_CATEGORY, "CC-BY-4.0"),
            ...
            new String[] {"Creative Commons Attribution 4.0 International Public License\n"});
    }
}
