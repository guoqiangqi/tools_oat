 ...
 * @since 1.0
 */
public class SameLicense extends OhosSimplePatternLicense {
    public SameLicense() {
        super(new MetaData.Datum(RAT_URL_LICENSE_FAMILY_CATEGORY, "SameLicense"),
            new MetaData.Datum(RAT_URL_LICENSE_FAMILY_NAME, "SameLicense"), "",
            new String[] {"same license as ", "the license found in the file", "see license"});
    }
    ...
    public boolean match(final Document pSubject, final String pLine) throws RatHeaderAnalysisException {
        ...
        if (OhosMatchUtils.stopWhileMatchedAny(value)) {
            return false;
        }
